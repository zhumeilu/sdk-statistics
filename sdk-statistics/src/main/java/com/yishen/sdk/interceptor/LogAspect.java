...
public class LogAspect {
	...
	protected static final org.apache.logging.log4j.Logger _log      = LogManager.getLogger(LogAspect.class);
	// 开始时间
	private                long                            startTime = 0L;
	// 结束时间
	private                long                            endTime   = 0L;
	@Autowired
	public ISystemLogManager systemLogManager;
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		SystemLog upmsLog = new SystemLog();
		// 从注解中获取操作名称、获取响应结果
		...
		upmsLog.setSpendTime( (endTime - startTime));
		upmsLog.setCreateDate(new Date(startTime));
		...
		systemLogManager.insert(upmsLog);
		return result;
	}
}
