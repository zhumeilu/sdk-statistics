...
<form class="layui-form">
	...
	<script type="text/html" id="newsListBar">
		...
		<a class="layui-btn layui-btn-xs " lay-event="rolePermission">分配权限</a>
...
<script>
    layui.use(['form','layer','laydate','table','laytpl'],function(){
        ...
        var tableIns = table.render({
            ...
            id : "newsListTable",
            cols : [[
                {type: "checkbox", fixed:"left", width:50,checked:true},
        ...
        function addNews(edit){
            ...
            var index = layui.layer.open({
                title : "添加角色",
                type : 2,
                content : "${basePath}/role/add?id="+id,
                method:'get',
        ...
        $(".delAll_btn").click(function(){
            ...
            if(data.length > 0) {
                ...
                layer.confirm('确定删除选中的角色？', {icon: 3, title: '提示信息'}, function (index) {
                    $.post("${basePath}/role/batchDelete",{
        ...
        table.on('tool(newsList)', function(obj){
            ...
            }else if(layEvent ==='rolePermission'){
                rolePermission(data);
            }
        });
        function rolePermission(edit){
            var id = "";
            if(edit){
                id = edit.id;
            }
            var index = layui.layer.open({
                title : "添加权限",
                type : 2,
                content : "${basePath}/role/rolePermission?id="+id,
                method:'get',
                success : function(layero, index){
                    var body = layui.layer.getChildFrame('body', index);
                    setTimeout(function(){
